...
def index(request):
    ...
    num_books_particular_word = Book.objects.filter(title__contains='Der').count()
...
class AuthorCreate(PermissionRequiredMixin, CreateView):
    ...
    permission_required = 'catalog.can_create_update_delete_authors'
